...
export default function HeroSection() {
  return (
    ...
    >
      ...
      <div className="relative max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20 lg:py-24">
          ...
          <div>
            ...
            <div className="flex flex-col sm:flex-row gap-3 mb-8">
              <Link
                ...
                className="btn-primary text-base py-3.5 px-6 justify-center sm:justify-start"
              >
                <Truck size={18} />
                أنشئ طلب نقل
              </Link>
              <Link
                ...
                className="btn-outline-white text-base py-3.5 px-6 justify-center sm:justify-start"
              >
                أنا مزود خدمة
                <ArrowLeft size={18} />
              </Link>
