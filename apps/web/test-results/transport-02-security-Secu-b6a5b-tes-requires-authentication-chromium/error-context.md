...
- Name: transport\02-security.spec.ts >> Security — AuthGuard (B3) >> B3: /transport/my-quotes requires authentication
- Location: e2e\transport\02-security.spec.ts:105:7
...
Received string:  "https://souq-one-om-web.vercel.app/ar/transport/my-quotes"
```
