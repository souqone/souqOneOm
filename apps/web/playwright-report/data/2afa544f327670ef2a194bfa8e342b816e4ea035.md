...
- Name: transport\02-security.spec.ts >> Security — AuthGuard (B3) >> B3: /transport/my-requests requires authentication
- Location: e2e\transport\02-security.spec.ts:111:7
...
Received string:  "https://souq-one-om-web.vercel.app/ar/transport/my-requests"
```
