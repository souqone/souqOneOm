...
const BADGE_MAP: Record<string, BadgeStyle> = {
  ...
  EQUIPMENT_WANTED:       { label: 'مطلوب',        dot: 'bg-orange-500',  cls: 'bg-orange-50 text-orange-800 border-orange-200 dark:bg-orange-900/30 dark:text-orange-300 dark:border-orange-800' },
  // ── Part & Service ──
