...
/**
 * Schema for validating Car Listings using Zod.
 * Enforces business rules and strict type safety before API submission.
 */
export const carListingSchema = z.object({
  ...
  year: z.coerce
    ...
    .max(2026, { message: 'سنة الصنع غير صالحة.' }), // Allow next year for new models
