      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-3 mb-4">
            {[
              { value: 'asap' as const, label: 'في أقرب وقت', sublabel: 'أريد النقل في أسرع وقت ممكن', Icon: Clock },
              { value: 'scheduled' as const, label: 'موعد محدد', sublabel: 'لديّ تاريخ ووقت محدد', Icon: Calendar },
            ...
            <div>
              ...
              <div className="mt-3 flex items-center justify-between p-3 bg-[var(--color-surface-container)] rounded-xl">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <p className="text-sm font-bold text-[var(--color-on-surface)]">الموعد مرن</p>
        ...
        <div>
          ...
          <p className="text-[11px] text-[var(--color-on-surface-muted)] mb-3">
            تحديد نطاق الميزانية يساعد على جذب عروض مناسبة.
          </p>

          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="block text-xs font-bold text-[var(--color-on-surface-variant)] mb-1.5">الحد الأدنى</label>
            ...
            <div>
              <label className="block text-xs font-bold text-[var(--color-on-surface-variant)] mb-1.5">الحد الأقصى</label>
              <div className="relative">
                <input
                  {...register('budgetMax')}
                  type="number"
          ...
          <div className="mt-3">
            <p className="text-[11px] text-[var(--color-on-surface-muted)] mb-2">نطاقات شائعة:</p>
